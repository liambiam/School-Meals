...
def perform_text_clustering(texts, max_clusters=5):
    # Tokenize sentences
    ...
    # Based on the elbow and silhouette plots, choose the optimal number of clusters
...
perform_text_clustering(input_text)
