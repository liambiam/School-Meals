...
def perform_topic_modeling(texts, num_topics, output_file):
...
# Store the perplexity and coherence scores
perplexity_scores = []
coherence_scores = []

# Perform topic modeling and save results to 'analysis{i}.txt'
if __name__ == "__main__":
    for i in range(11, 21):
        perplexity, coherence = perform_topic_modeling(texts, num_topics=i, output_file=f"analysis{i}.txt")
        perplexity_scores.append(perplexity)
        coherence_scores.append(coherence)

    # Print the perplexity and coherence scores
    for i, (perplexity, coherence) in enumerate(zip(perplexity_scores, coherence_scores), start=2):
        print(f"Topics: {i}")
        print(f"Perplexity Score: {perplexity}")
        print(f"Coherence Score: {coherence}")
        print()
    print(perplexity_scores, coherence_scores)