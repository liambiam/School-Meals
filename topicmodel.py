...
from gensim import corpora, models, matutils  # Import matutils explicitly
...
perform_topic_modeling(texts, num_topics=8, output_file="topic_modeller_analysis8.txt")
